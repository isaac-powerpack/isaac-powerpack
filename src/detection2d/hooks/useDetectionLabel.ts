...
export function useDetectionLabel(context: PanelExtensionContext, variables: ReadonlyMap<string, any> | undefined, variableName: string | undefined) {
    ...
    const labels = variables?.get(variableName || "") ?? variables?.get(DEFAULT_OBJECT_LABEL_VAR_NAME);
